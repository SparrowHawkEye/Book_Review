...
const About = () => {
  return (
      <div className="flex h-[80vh] mb-28 lg:mb-0 md:mb-24">
        <div className="max-w-4xl flex items-center h-auto lg:h-[90%] flex-wrap mx-auto my-32 lg:my-0">
        <div
          id="profile"
        ...
        >
          <div className="p-4 md:p-12 text-center lg:text-left">
            ...
            <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
              ...
              Professionally I am a Structural Engineer.
            </p>
            <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
              <svg
                className="h-4 fill-current text-green-700 pr-4"
